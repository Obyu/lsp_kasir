                                    ...
                                    <form action="{{ route('pesanan.store') }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <label for="nama"
                                                ...
                                                type="text" placeholder="{{ $pelanggans->Namapelanggan }}"  readonly>
                                                <input name="pelanggan"
                                                class="hidden w-full placeholder:text-13 text-13 py-1.5 rounded border-gray-100 focus:border focus:border-violet-50 focus:ring focus:ring-violet-500/20 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 placeholder:text-gray-800 dark:text-zinc-100"
                                                type="text" placeholder="Masukkan Jumlah Pesanan" id="jumlah" value="{{ $pelanggans->idpelanggan }}" readonly>
                                            </div>
                                            <label for="nama"
                                                class="block mb-2 font-medium text-gray-700 dark:text-gray-100">Nomor Meja</label>
                                                <input placeholder="{{ $mejas->NoMeja }}" class="dark:bg-zinc-800 dark:border-zinc-700 w-full rounded border-transparent py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:text-zinc-100" fdprocessedid="5vhotj" readonly>
                                                <input name="meja" value="{{ $mejas->id }}" class="hidden dark:bg-zinc-800 dark:border-zinc-700 w-full rounded border-transparent py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:text-zinc-100" fdprocessedid="5vhotj">
